      ...
      <div className="container">
            ...
            <td>
              <div className="top-collection__collectionBlock">
                ...
                <div className="top-collection__collectionBLockText">
                  <div className="top-collection__collectionUser">Alex Ca.</div>
                  <div className="top-collection__collectionByUser">By Alex Ca.</div>
                </div>
              </div>
            </td>
            <td>
        ...
        <a href="#">Explore All
          <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M8.80176 1.36621L15.7841 8.34859L8.80176 15.331" stroke="#ACADB9" stroke-width="1.99471" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </a>
