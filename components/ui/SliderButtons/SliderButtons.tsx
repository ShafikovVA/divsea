...
const SliderButtons = (props: ISliderButtons) => {
  const {
    onClickNext,
    onClickPrev,
    isNextActive,
  ...
  return (
    <div className="slider__buttons">
      <div className={`button-left ${prevButtonClassName} ${!cssMode && !isPrevActive && 'disabled'}`}
           onClick={onClickPrev}>
      ...
      <div className="slider__buttons-border"></div>
      <div className={`button-right ${nextButtonClassName} ${!cssMode && !isNextActive && 'disabled'}`}
           onClick={onClickNext}>
        <svg width="27" height="27" viewBox="0 0 27 27" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" clipRule="evenodd"
